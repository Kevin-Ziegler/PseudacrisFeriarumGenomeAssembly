#This file filters out reads > 40k from the ends of contigs. No much "real" interaction happens past this range
#It filters from nodups and rewrites to a file
