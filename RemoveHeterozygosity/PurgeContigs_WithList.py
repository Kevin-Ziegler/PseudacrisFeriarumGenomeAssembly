#Given the list of heterozygous regions to remove from RepurgeMM.py, create a new fasta file with those regions removed.
...
#New heterozygosity removed contig fasta file
outputFile = "P_fer_HeterozygousParameters.contigs.purged_RepurgedMMSplit_4_2_2024.fasta"

#input list of regions to remove, output from RepurgeMM.py
listAutomatedRemove = "ListOfRegionsToRemove_PurgeMultiMap_Split.txt"
